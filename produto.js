    ...
    for (let i = 0; i < produtos.length; i++) {
        ...
        <div class="col-4">
                <div class="card mb-4" style="width: 18rem;">
                    <img style="height: 150px; object-fit: contain;" src="${produto.imagem}" class="card-img-top" alt="...">
                    <div class="card-body">
                      <h5 class="card-title">${produto.nome}</h5>
                      <p>R$ ${produto.valor}</p>
                      <p class="card-text">${produto.descricao}</p>
                      <button type="button" onclick="atualizaProduto(${i})" class="btn btn-dark">Editar</button>
                      <button type="button" onclick="deletaProduto(${i})" class="btn btn-danger">Excluir</button>
                    </div>
                  </div>
            </div>
            `;
...
function atualizaProduto(index){
    ...
    document.getElementById("action").innerText = "Cadastrar Produto";
